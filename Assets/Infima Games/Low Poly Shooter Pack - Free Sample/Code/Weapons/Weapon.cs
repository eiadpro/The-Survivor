...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Weapon : WeaponBehaviour
    {
        ...
        {
            print("ammo " + ammunitiontotal);
            //Update the value by a certain amount.
            if (ammunitiontotal > 0&& GetAmmunitionTotal() == 30)
            {
               
                int last = ammunitionCurrent;
                ammunitionCurrent = amount != 0 ? Mathf.Clamp(ammunitionCurrent + amount,
                    0, GetAmmunitionTotal()) : magazineBehaviour.GetAmmunitionTotal();
                ammunitiontotal -= ammunitionCurrent - last;
        ...
        public override int AmmunitionTotal()
        {
        ...
        {
            ammunitiontotal = Mathf.Min(180, ammunitiontotal + 30);
        }
